...
NOISE=0
DURATION=1
TRAIN_TRACE_PATH="../BO-data/randomize-BW-TS/train-manual"
...
for NOISE in 0 ; do
    ...
    SUMMARY_DIR="../BO-results/randomize-BW-TS-4/"
    python ${SIMULATOR_DIR}/multi_agent.py \
        ...
        --nn_model='../BO-results/randomize-BW-TS-2/model_saved/nn_model_ep_4100.ckpt'
